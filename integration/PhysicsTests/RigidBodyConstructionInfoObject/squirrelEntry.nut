...
function start(){
    ...
    local firstInfoObject = _physics.dynamics.createConstructionInfo(firstInfo);
    local secondInfoObject = _physics.dynamics.createConstructionInfo(secondInfo);

    local bodyFirst = _physics.dynamics.createRigidBody(shape, firstInfoObject);
    local bodySecond = _physics.dynamics.createRigidBody(shape, secondInfoObject);
